...
// https://paiza.io/projects/t26CxWhiRUgi2XLs9VWjdw?language=php
...
$data_history = [
    ...
    [
      ...
      "dateStart" => "Jan 2015",
      "dateEnd" => "Current",
      "description" =>"Lorem ipsum dolor sit amet. Praesentium magnam 
  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <?php for ($i=count($data_history)-1; $i>=0; $i-- ):?>
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?php echo($data_history[$i]["name"]);?></b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>
          <?php echo($data_history[$i]["dateStart"]); ?> - 
          <?php if ($data_history[$i]["dateEnd"] == "Current"):?>
            <span class="w3-tag w3-teal w3-round">
             <?php echo($data_history[$i]["dateEnd"]);?>
            </span>
          <?php else:?> 
             <?php echo($data_history[$i]["dateEnd"]);?> 
             <?php endif;?>
          ...
          <p>
            <?php echo($data_history[$i]["description"]);?></p>         
          <hr>
        </div>
        <?php endfor; ?>
